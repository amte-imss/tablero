<?php echo js('registro/validaciones.js')
?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="container" style="text-aligne:center; width: 650px; text-align: left;">
                    ...
                    <?php
                    echo form_open('registro/agregar_usuario', array('id' => 'form_registro'));
                    ?>
                    <!--Matriculas-->
                    ...
                    <div class="form-group">
                        ...
                        <!-- <div class="col-md-4"> -->
                        <button id="submit" name="submit" type="submit" class="btn btn-primary" data-idmodal="#divModal" ><a class="btn-primary" href="assets/app/controllers/gestion_usuario/modal_info_usuario.html">Guardar</a>     <span class="glyphicon glyphicon-send"></span></button>
                    </div>
                    <!-- </div> -->
                    <?php echo form_close(); ?>
